...
<title>外部项目费用结算单---上海通用汽车/泛亚技术中心研发试验中心</title>
</head>
<body>
	<div class="main">
		<div class="header">
										...
										<thead>
											<tr>
												<th data-options="field:'No',width:60,align:'center'"
													rowspan="2">结算单号</th>
												<th data-options="field:'No',width:63,align:'center'"
													rowspan="2">试验<br>项目号
												</th>
												<th data-options="field:'name',width:63,align:'center'"
													rowspan="2">客户企业</th>
												<th data-options="field:'name',width:63,align:'center'"
													rowspan="2">项目<br>负责人
												</th>
												<th data-options="field:'pjno',width:63,align:'center'"
													rowspan="2">项目预<br>算结余
												</th>
												<th data-options="field:'subpjno',width:63,align:'center'"
													rowspan="2">开始时间</th>
												<th data-options="field:'reason',width:63,align:'center'"
													rowspan="2">结束时间</th>
												<th data-options="align:'center'" colspan="4">结算费用</th>
												<th data-options="field:'reason',width:63,align:'center'"
													rowspan="2">生成时间</th>
												<th data-options="field:'reason',width:63,align:'center'"
													rowspan="2">处理状态</th>
											...
											<tr>
												<th data-options="field:'applier',width:50,align:'center'">道路试验</th>
												<th data-options="field:'date',width:50,align:'center'">租赁费用</th>
												<th data-options="field:'status',width:50,align:'center'">试验杂费</th>
												<th data-options="field:'OV',width:43,align:'center'">人工</th>
											</tr>
										</thead>
									</table>
							...
							<div title="待生成费用结算单">
								...
								<div>
									<table class="easyui-datagrid" title=""
										...
										data-options="collapsible:true,maximizable:true,singleSelect:false,url:'datagrid/road.json',toolbar:'#tb_1',
																	              pagination:true,pageSize:10">
	...
	<div class="ywcx-content2">
		<div id="wa2" class="easyui-window" title="外部项目费用结算单"
			...
			<div id="child1_tab" class="easyui-tabs"
				...
				<div title="结算单信息">
					<table id="costGather" class="easyui-datagrid" title=""
						...
						data-options="url:'datagrid/cost_type.json',
								              toolbar:'#child_tb2',showFooter: true">
						<thead>
							<tr>
								<th data-options="field:'type',width:200">计费项目</th>
								<th data-options="field:'price',width:420">费用合计</th>
							</tr>
						</thead>
					</table>
				</div>
				...
				<script type="text/javascript">
								...
								.datagrid(
										{
											...
											onExpandRow : function(index, row) {
												$('#ddv-' + index)
														.datagrid(
																{
																	url : 'datagrid/cost_type_detail_'
																			+ row.id
																			+ '.json',
																	fitColumns : true,
																	singleSelect : true,
					...
					function endEditing4() {
						...
						if ($('#ddv1').datagrid('validateRow', editIndex4)) {
							var ed = $('#ddv1').datagrid('getEditor', {
								index : editIndex4,
								field : 'type'
							});
					...
					function onClickRow4(index) {
						if (editIndex4 != index) {
							if (endEditing4()) {
								$('#ddv1').datagrid('selectRow', index)
										.datagrid('beginEdit', index);
								editIndex4 = index;
							} else {
								$('#ddv1').datagrid('selectRow', editIndex4);
							}
						}
					}
				</script>
					...
					<table class="easyui-datagrid" title=""
						...
						<thead>
							<tr>
								...
								<th data-options="field:'cost',width:65" rowspan="2">费用合计</th>
								<th colspan="5">道路费用</th>
								<th colspan="2">杂费</th>
								<th colspan="5">油费</th>
							</tr>
							<tr>
					...
					<table class="easyui-datagrid" title=""
						...
						<thead>
							<tr>
								...
								<th data-options="width:90">费用合计</th>
							...
							<tr>
								...
								<th data-options="field:'count',width:90">元</th>
			...
			<div align='center'>
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					href="javascript:void(0)" class="easyui-linkbutton"
					onclick="submitForm()">取 消</a> <a href="javascript:void(0)"
					class="easyui-linkbutton" onclick="submitForm()">导 出</a>
			</div>
		</div>
	</div>
	<!--确认单弹出页面结束-->
