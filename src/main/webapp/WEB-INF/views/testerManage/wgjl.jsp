...
<head>
    ...
    <title>违规记录---上海通用汽车/泛亚技术中心研发试验中心</title>
</head>
<body>
    <div class="main">
        <div class="header">
                    ...
                    <div class="table-m-m">
                    	  ...
                    	  <div>
													<table class="easyui-datagrid" title="" style="width:799px;height:330px;padding:5px"
															data-options="collapsible:true,maximizable:true,singleSelect:false,url:'datagrid/applist.json',toolbar:'#tb',
														...
														<thead>
															<tr>
																...
																<th data-options="field:'name',width:125,align:'center'">违规类别</th>
																<th data-options="field:'pjno',width:90,align:'center'">扣除分数</th>
																<th data-options="field:'subpjno',width:90,align:'center'">发生地点</th>
																<th data-options="field:'reason',width:90,align:'center'">发生时间</th>
																<th data-options="field:'reason',width:90,align:'center'">发生原因</th>
																<th data-options="field:'role',width:90,align:'center'">发生人</th>
																<th data-options="field:'applier',width:56,align:'center'">所属企业</th>
															</tr>
														</thead>
													</table>
													<div id="tb" style="height:auto">
														<div >
															<a href="javascript:void(0)" onclick="$('#wa').window('open')" class="easyui-linkbutton" iconCls="icon-add" plain="true">新增</a>
															<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true">清零</a>
														</div>
													</div>
												</div>	
                    </div>
  ...
  <!--新增申请的弹出页面开始-->
	<div class="ywcx-content2">
		<div id="wa" class="easyui-window" title="违规记录" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width: 720px; height: 350px; padding:10px 0 10px 0px">
				      <table class="table-left">
				          ...
				          <tr>
				              ...
				              <td colspan="2">
				                  <input class="easyui-combobox" type="text" name="name" data-options="required:true" /></td>		                                    
				              <td>发生人：</td>
				              <td colspan="2"><input class="easyui-combobox" type="text" name="name" data-options="required:true"  /></td>
				              <td>所属企业：</td>
				              	<td colspan="3">
				          ...
				          <tr>
				              <td>事故原因：</td>
				              <td colspan="8">
				                  <textarea name="message" style="height: 150px; width: 99%; text-align: left"></textarea></td>
				          </tr>
				          <tr>
				              <td>本次扣除分数：</td>
