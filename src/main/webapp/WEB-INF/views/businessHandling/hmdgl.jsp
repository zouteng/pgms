...
<title>黑名单管理---上海通用汽车/泛亚技术中心研发试验中心</title>
</head>
<body>
	<div class="main">
		<div class="header">
							...
							<table class="easyui-datagrid" title=""
								...
								<thead>
									<tr>
										...
										<th data-options="field:'No',width:110,align:'center'"
											rowspan="2">用户名</th>
										<th data-options="field:'name',width:125,align:'center'"
											rowspan="2">所属企业</th>
										<th data-options="align:'center'" colspan="3">1月内不到场情况</th>
										<th data-options="field:'subpjno',width:90,align:'center'"
											rowspan="2">黑名单</th>
									</tr>
									<tr>
										<th data-options="field:'No',width:110,align:'center'">预约/包场次数</th>
										<th data-options="field:'name',width:110,align:'center'">不到场次数</th>
										<th data-options="field:'subpjno',width:110,align:'center'">不到场率</th>
									</tr>
								</thead>
							</table>
							<div id="tb" style="height: auto">
								<div>
									<a href="javascript:void(0)" onclick=""
										class="easyui-linkbutton" iconCls="icon-add" plain="true">加入黑名单</a>
